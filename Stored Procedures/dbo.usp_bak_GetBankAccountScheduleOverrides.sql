...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_bak_GetBankAccountScheduleOverrides]
...
BEGIN
  SELECT a.BankAccountId,a.DeviceId,d.TerminalName,
         ...
         WHERE a.BankAccountId=@BankAccountId AND a.FundsType=1
         ORDER BY d.TerminalName
END
GO
GRANT EXECUTE ON  [dbo].[usp_bak_GetBankAccountScheduleOverrides] TO [WebV4Role]
GO
