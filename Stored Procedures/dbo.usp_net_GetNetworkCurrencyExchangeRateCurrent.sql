...
CREATE PROCEDURE [dbo].[usp_net_GetNetworkCurrencyExchangeRateCurrent]
@NetworkId    bigint,
@FromCurrency bigint,
@ToCurrency   bigint
AS
BEGIN
  SELECT 
  e.Id NetworkCurrencyExchangeRateId,e.NetworkId,
  ...
  e.ExchangeRate,e.UpdatedDate,e.UpdatedUserId,u.UserName UpdatedUserName
  FROM dbo.tbl_NetworkCurrencyExchangeRate e
...
END
GO
GRANT EXECUTE ON  [dbo].[usp_net_GetNetworkCurrencyExchangeRateCurrent] TO [WebV4Role]
GO
