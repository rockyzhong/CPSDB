...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_rep_GetTransactionForAccounting]
    @UserId bigint,
    @IsoId bigint,
...
BEGIN
    ...
    SET @SQL = N'
        ...
        SELECT
            ...
            t.CustomerId,
            cm.MembershipNumber,
            ISNULL(c.FirstName, '''') + SPACE(1) + ISNULL(c.LastName, '''') CustomerName,
        ...
        LEFT JOIN dbo.tbl_Country n ON r.CountryId = n.Id
        ...
        LEFT JOIN dbo.tbl_CustomerMembership cm ON  t.Customerid = cm.CustomerId And cm.isoid=@isoid
    ...
    IF @SortField=0 and @SortOrder=0
	  SET @SQL = @SQL + N' ORDER BY 4,t.CustomerId,13'
    IF @SortField=0 and @SortOrder=1
	  SET @SQL = @SQL + N' ORDER BY 4 desc,t.CustomerId,13'
	IF @SortField=1 and @SortOrder=0
	  SET @SQL = @SQL + N' ORDER BY t.SystemTime,t.CustomerId,13'
    IF @SortField=1 and @SortOrder=1
	  SET @SQL = @SQL + N' ORDER BY t.SystemTime desc,t.CustomerId,13'
