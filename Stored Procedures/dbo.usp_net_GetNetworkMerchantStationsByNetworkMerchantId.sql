...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_net_GetNetworkMerchantStationsByNetworkMerchantId] (@NetworkMerchantId bigint)
AS
BEGIN
  SELECT m.Id NetworkMerchantId,m.NetworkId,m.IsoId,m.MerchantId,
   ...
   WHERE s.NetworkMerchantId=@NetworkMerchantId
END
GO
GRANT EXECUTE ON  [dbo].[usp_net_GetNetworkMerchantStationsByNetworkMerchantId] TO [WebV4Role]
GO
