CREATE TABLE [dbo].[tbl_DeviceCommission]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[CommissionType] [bigint] NOT NULL,
[DispenseAmountPercent] [money] NOT NULL,
[SurchargeFixedAmountPercent] [money] NOT NULL,
[SurchargeVariableAmountPercent] [money] NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceCommission_AuditLog] ON [dbo].[tbl_DeviceCommission]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceCommission'
...
GO
ALTER TABLE [dbo].[tbl_DeviceCommission] ADD CONSTRAINT [pk_DeviceCommission] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceCommission_DeviceId_CommissionType] ON [dbo].[tbl_DeviceCommission] ([DeviceId], [CommissionType]) ON [PRIMARY]
GO
