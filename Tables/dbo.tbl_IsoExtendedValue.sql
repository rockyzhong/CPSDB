CREATE TABLE [dbo].[tbl_IsoExtendedValue]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[IsoId] [bigint] NULL,
[ExtendedColumnType] [bigint] NULL,
[ExtendedColumnValue] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_IsoExtendedValue_AuditLog] ON [dbo].[tbl_IsoExtendedValue]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_IsoExtendedValue'
...
GO
ALTER TABLE [dbo].[tbl_IsoExtendedValue] ADD CONSTRAINT [pk_IsoExtendedValue] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_IsoExtendedValue_IsoId_ExtendedColumnType] ON [dbo].[tbl_IsoExtendedValue] ([IsoId], [ExtendedColumnType]) ON [PRIMARY]
GO
