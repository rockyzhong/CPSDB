CREATE TABLE [dbo].[tbl_upm_UserQuestion]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[UserId] [bigint] NOT NULL,
[QuestionId] [bigint] NOT NULL,
[Answer] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_upm_UserQuestion_AuditLog] ON [dbo].[tbl_upm_UserQuestion]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_upm_UserQuestion'
...
GO
ALTER TABLE [dbo].[tbl_upm_UserQuestion] ADD CONSTRAINT [pk_UserQuestion] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_UserQuestion_UserId] ON [dbo].[tbl_upm_UserQuestion] ([UserId]) ON [PRIMARY]
GO
