CREATE TABLE [dbo].[tbl_CustomerMembership]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[IsoId] [bigint] NULL,
[CustomerId] [bigint] NOT NULL,
[MembershipNumber] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_CustomerMembership_AuditLog] ON [dbo].[tbl_CustomerMembership]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_CustomerMembership'
...
GO
ALTER TABLE [dbo].[tbl_CustomerMembership] ADD CONSTRAINT [pk_CustomerMembership] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_CustomerMembership_CustomerId_IsoId] ON [dbo].[tbl_CustomerMembership] ([CustomerId], [IsoId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_Customer_IsoIdCId] ON [dbo].[tbl_CustomerMembership] ([IsoId], [CustomerId]) ON [PRIMARY]
GO
