CREATE TABLE [dbo].[tbl_IsoContact]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[IsoId] [bigint] NOT NULL,
[ContactId] [bigint] NOT NULL,
[IsoContactType] [bigint] NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_IsoContact_AuditLog] ON [dbo].[tbl_IsoContact]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_IsoContact'
...
GO
ALTER TABLE [dbo].[tbl_IsoContact] ADD CONSTRAINT [pk_IsoContact] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_IsoContact_ContactId] ON [dbo].[tbl_IsoContact] ([ContactId]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_IsoContact_IsoId] ON [dbo].[tbl_IsoContact] ([IsoId]) ON [PRIMARY]
GO
