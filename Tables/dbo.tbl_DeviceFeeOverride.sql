CREATE TABLE [dbo].[tbl_DeviceFeeOverride]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[FeeOverridePriority] [bigint] NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceFeeOverride_AuditLog] ON [dbo].[tbl_DeviceFeeOverride]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceFeeOverride'
...
GO
ALTER TABLE [dbo].[tbl_DeviceFeeOverride] ADD CONSTRAINT [pk_DeviceFeeOverride] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceFeeOverride_DeviceId] ON [dbo].[tbl_DeviceFeeOverride] ([DeviceId]) ON [PRIMARY]
GO
