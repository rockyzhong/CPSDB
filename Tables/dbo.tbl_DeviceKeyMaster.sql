CREATE TABLE [dbo].[tbl_DeviceKeyMaster]
(
[Id] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[DeviceId] [bigint] NULL,
[KeyClass] [bigint] NULL,
[KeySequence] [bigint] NULL,
[Cryptogram] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceKeyMaster_AuditLog] ON [dbo].[tbl_DeviceKeyMaster]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceKeyMaster'
...
GO
ALTER TABLE [dbo].[tbl_DeviceKeyMaster] ADD CONSTRAINT [pk_DeviceKeyMaster] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceKeyMaster_DeviceId] ON [dbo].[tbl_DeviceKeyMaster] ([DeviceId]) ON [PRIMARY]
GO
