CREATE TABLE [dbo].[tbl_DeviceView]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[UserId] [bigint] NOT NULL,
[ViewName] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[PageSize] [bigint] NOT NULL,
[SortColumnId] [bigint] NULL,
[SortDirection] [nvarchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tbl_SPS_Terminal_UserView_SortDirection] DEFAULT ('ASC'),
[LoadAtStartUp] [bit] NOT NULL CONSTRAINT [DF_tbl_DeviceView_LoadAtStartUp] DEFAULT ((0)),
[GlobalView] [bit] NOT NULL CONSTRAINT [DF_tbl_DeviceView_GlobalView] DEFAULT ((0)),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF_tbl_DeviceView_CreatedDate] DEFAULT (getutcdate()),
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceView_AuditLog] ON [dbo].[tbl_DeviceView]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceView'
...
GO
ALTER TABLE [dbo].[tbl_DeviceView] ADD CONSTRAINT [pk_DeviceView] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
