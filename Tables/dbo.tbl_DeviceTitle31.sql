CREATE TABLE [dbo].[tbl_DeviceTitle31]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[WindowNumber] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[AreaID] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceTitle31_AuditLog] ON [dbo].[tbl_DeviceTitle31]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceTitle31'
...
GO
ALTER TABLE [dbo].[tbl_DeviceTitle31] ADD CONSTRAINT [pk_DeviceTitle31] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceTitle31_DeviceId] ON [dbo].[tbl_DeviceTitle31] ([DeviceId]) ON [PRIMARY]
GO
