...
[HolderName] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Rta] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[IsoId] [bigint] NULL,
[BankAccountStatus] [bigint] NOT NULL,
[CriminalCheckStatus] [bigint] NULL,
[CriminalCheckIssueDate] [datetime] NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_BankAccount_AuditLog] ON [dbo].[tbl_BankAccount] WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_BankAccount'
      ...
      INSERT INTO dbo.tbl_AuditLogSource(TableName,PrimaryKeyField,PrimaryKeyValue,UpdatedDate,SourceType,SourceId) SELECT @TableName,'Id',COALESCE(i.Id,d.Id),@UpdatedDate,3,COALESCE(i.Id,d.Id) FROM inserted i FULL OUTER JOIN deleted d ON i.id=d.id
GO
ALTER TABLE [dbo].[tbl_BankAccount] ADD CONSTRAINT [pk_BankAccount] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_BankAccount_AddressId] ON [dbo].[tbl_BankAccount] ([AddressId]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_BankAccount_BankAddressId] ON [dbo].[tbl_BankAccount] ([BankAddressId]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_BankAccount_IsoId] ON [dbo].[tbl_BankAccount] ([IsoId]) ON [PRIMARY]
GO
