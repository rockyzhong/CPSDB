CREATE TABLE [dbo].[tbl_IsoCardTypeAllow]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[IsoId] [bigint] NOT NULL,
[CardTypeValue] [bigint] NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_tbl_IsoCardTypeAllow_AuditLog] ON [dbo].[tbl_IsoCardTypeAllow]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_tbl_IsoCardTypeAllow'
...
GO
ALTER TABLE [dbo].[tbl_IsoCardTypeAllow] ADD CONSTRAINT [pk_IsoCardTypeAllow] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
