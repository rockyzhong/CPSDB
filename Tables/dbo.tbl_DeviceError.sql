CREATE TABLE [dbo].[tbl_DeviceError]
(
...
[ErrorText] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ResolvedDate] [datetime] NULL,
[ResolvedText] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceError_AuditLog] ON [dbo].[tbl_DeviceError]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceError'
...
GO
ALTER TABLE [dbo].[tbl_DeviceError] ADD CONSTRAINT [pk_DeviceError] PRIMARY KEY NONCLUSTERED  ([id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceError_DeviceId_ResolvedDate_ErrorCode_AccessoryCode] ON [dbo].[tbl_DeviceError] ([DeviceId], [ResolvedDate], [ErrorCode], [AccessoryCode]) WITH (FILLFACTOR=80, PAD_INDEX=ON) ON [PRIMARY]
GO
