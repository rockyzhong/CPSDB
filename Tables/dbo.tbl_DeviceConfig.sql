CREATE TABLE [dbo].[tbl_DeviceConfig]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[DeviceConfigFileId] [bigint] NOT NULL,
[DeviceOverrideFileId] [bigint] NULL,
[ConfigID] [nvarchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceConfig_AuditLog] ON [dbo].[tbl_DeviceConfig]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceConfig'
...
GO
ALTER TABLE [dbo].[tbl_DeviceConfig] ADD CONSTRAINT [pk_DeviceConfig] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_DeviceConfig_DeviceId] ON [dbo].[tbl_DeviceConfig] ([DeviceId]) ON [PRIMARY]
GO
