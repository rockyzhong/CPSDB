CREATE TABLE [dbo].[tbl_CustomerOTB]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[CustomerId] [bigint] NULL,
[MerchantId] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[TransactionClass] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[FullMICR] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[OTBLimit] [bigint] NULL,
[ActiveStatus] [nvarchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[EnrollmentType] [nvarchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_CustomerOTB_AuditLog] ON [dbo].[tbl_CustomerOTB]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_CustomerOTB'
...
GO
ALTER TABLE [dbo].[tbl_CustomerOTB] ADD CONSTRAINT [pk_CustomerOTB] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_CustomerOTB_CustomerId] ON [dbo].[tbl_CustomerOTB] ([CustomerId]) ON [PRIMARY]
GO
