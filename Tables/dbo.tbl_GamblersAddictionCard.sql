CREATE TABLE [dbo].[tbl_GamblersAddictionCard]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[CustomerMediaDataHash] [varbinary] (512) NOT NULL,
[CustomerMediaDataEncrypted] [varbinary] (512) NOT NULL,
[Active] [bit] NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_GamblersAddictionCard_AuditLog] ON [dbo].[tbl_GamblersAddictionCard]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_GamblersAddictionCard'
...
GO
ALTER TABLE [dbo].[tbl_GamblersAddictionCard] ADD CONSTRAINT [pk_GamblersAddictionCard] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
