CREATE TABLE [dbo].[tbl_DeviceViewFilter]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[ViewId] [bigint] NOT NULL,
[FilterId] [bigint] NOT NULL,
[Value] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[MatchChoice] [nvarchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_DeviceViewFilter_MatchChoice] DEFAULT ('='),
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceViewFilter_AuditLog] ON [dbo].[tbl_DeviceViewFilter]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceViewFilter'
      ...
      INSERT INTO dbo.tbl_AuditLogSource(TableName,PrimaryKeyField,PrimaryKeyValue,UpdatedDate,SourceType,SourceId) SELECT @TableName,'Id',COALESCE(i.Id,d.Id),@UpdatedDate,2,a.UserId FROM inserted i FULL OUTER JOIN deleted d ON i.id=d.id JOIN dbo.tbl_DeviceView a ON COALESCE(i.ViewId,d.ViewId)=a.Id
GO
ALTER TABLE [dbo].[tbl_DeviceViewFilter] ADD CONSTRAINT [pk_DeviceViewFilter] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_DeviceViewFilter_ViewId_FilterId] ON [dbo].[tbl_DeviceViewFilter] ([ViewId], [FilterId]) ON [PRIMARY]
GO
