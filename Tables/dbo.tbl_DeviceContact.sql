CREATE TABLE [dbo].[tbl_DeviceContact]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[ContactId] [bigint] NOT NULL,
[DeviceContactType] [bigint] NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceContact_AuditLog] ON [dbo].[tbl_DeviceContact]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceContact'
...
GO
ALTER TABLE [dbo].[tbl_DeviceContact] ADD CONSTRAINT [pk_DeviceContact] PRIMARY KEY CLUSTERED  ([Id]) WITH (FILLFACTOR=80, PAD_INDEX=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceContact_ContactId] ON [dbo].[tbl_DeviceContact] ([ContactId]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_DeviceContact_DeviceId] ON [dbo].[tbl_DeviceContact] ([DeviceId]) ON [PRIMARY]
GO
