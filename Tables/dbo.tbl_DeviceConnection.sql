CREATE TABLE [dbo].[tbl_DeviceConnection]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[ProtocolType] [bigint] NOT NULL,
[Caller] [bigint] NULL,
[LocalAddress] [bigint] NULL,
[CommsAPIType] [bigint] NULL,
[LocalIPAddress] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[LocalPort] [bigint] NULL,
[RemoteIPAddress] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[RemotePort] [bigint] NULL,
[IPAddressFlags] [bigint] NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceConnection_AuditLog] ON [dbo].[tbl_DeviceConnection]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceConnection'
...
GO
ALTER TABLE [dbo].[tbl_DeviceConnection] ADD CONSTRAINT [pk_DeviceIPAddress] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_DeviceConnection_DeviceId] ON [dbo].[tbl_DeviceConnection] ([DeviceId]) ON [PRIMARY]
GO
