CREATE TABLE [dbo].[tbl_DeviceCutoverOffset]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[DeviceId] [bigint] NOT NULL,
[FundsType] [bigint] NOT NULL,
[DepositExec] [bit] NOT NULL,
[CutoverOffset] [bigint] NOT NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_DeviceCutoverOffset_AuditLog] ON [dbo].[tbl_DeviceCutoverOffset]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_DeviceCutoverOffset'
...
GO
ALTER TABLE [dbo].[tbl_DeviceCutoverOffset] ADD CONSTRAINT [pk_DeviceCutoverOffset] PRIMARY KEY CLUSTERED  ([Id]) WITH (FILLFACTOR=80, PAD_INDEX=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_DeviceCutoverOffset_DeviceId_FundsType] ON [dbo].[tbl_DeviceCutoverOffset] ([DeviceId], [FundsType]) WITH (FILLFACTOR=80, PAD_INDEX=ON) ON [PRIMARY]
GO
