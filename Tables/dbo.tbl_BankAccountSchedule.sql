CREATE TABLE [dbo].[tbl_BankAccountSchedule]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[BankAccountId] [bigint] NOT NULL,
[FundsType] [bigint] NOT NULL,
[ScheduleType] [bigint] NOT NULL CONSTRAINT [DF_tbl_BankAccountSchedule_ScheduleType] DEFAULT ((1)),
[ScheduleDay] [bigint] NOT NULL CONSTRAINT [DF_tbl_BankAccountSchedule_ScheduleDay] DEFAULT ((0)),
[SchedulePayoutDay] [bigint] NOT NULL CONSTRAINT [DF_tbl_BankAccountSchedule_SchedulePayoutDay] DEFAULT ((0)),
[ThresholdAmount] [bigint] NOT NULL CONSTRAINT [DF_tbl_BankAccountSchedule_ThresholdAmount] DEFAULT ((0)),
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_BankAccountSchedule_AuditLog] ON [dbo].[tbl_BankAccountSchedule]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_BankAccountSchedule'
...
GO
ALTER TABLE [dbo].[tbl_BankAccountSchedule] ADD CONSTRAINT [pk_BankAccountSchedule] PRIMARY KEY NONCLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_BankAccountSchedule_AchFileId] ON [dbo].[tbl_BankAccountSchedule] ([AchFileId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_BankAccountSchedule_BankAccountId_FundsType] ON [dbo].[tbl_BankAccountSchedule] ([BankAccountId], [FundsType]) ON [PRIMARY]
GO
