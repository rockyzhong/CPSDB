CREATE TABLE [dbo].[tbl_IsoAddress]
(
[Id] [bigint] NOT NULL IDENTITY(1, 2) NOT FOR REPLICATION,
[IsoId] [bigint] NOT NULL,
[AddressId] [bigint] NOT NULL,
[IsoAddressType] [bigint] NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_IsoAddress_AuditLog] ON [dbo].[tbl_IsoAddress]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_IsoAddress'
...
GO
ALTER TABLE [dbo].[tbl_IsoAddress] ADD CONSTRAINT [pk_IsoAddress] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_IsoAddress_AddressId] ON [dbo].[tbl_IsoAddress] ([AddressId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_IsoAddress_IsoId_IsoAddressType] ON [dbo].[tbl_IsoAddress] ([IsoId], [IsoAddressType]) ON [PRIMARY]
GO
