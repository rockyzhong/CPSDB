CREATE TABLE [dbo].[tbl_CustomerMedia]
(
...
[CustomerMediaExpiryDate] [varchar] (512) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[tbl_CustomerMedia_AuditLog] ON [dbo].[tbl_CustomerMedia]     WITH EXECUTE AS 'dbo' FOR INSERT, UPDATE, DELETE NOT FOR REPLICATION
    AS
      SET NOCOUNT ON
      DECLARE @TableName varchar(200),@UpdatedDate varchar(21),@Type varchar(1),@FieldName varchar(200),@SQL nvarchar(4000)
      SELECT @TableName = 'tbl_CustomerMedia'
...
GO
ALTER TABLE [dbo].[tbl_CustomerMedia] ADD CONSTRAINT [PK_tbl_CustomerMedia] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_CustomerMedia_CustomerId] ON [dbo].[tbl_CustomerMedia] ([CustomerId]) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'SHA1 hashed data (card number)', 'SCHEMA', N'dbo', 'TABLE', N'tbl_CustomerMedia', 'COLUMN', N'CustomerMediaDataHash'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Check no', 'SCHEMA', N'dbo', 'TABLE', N'tbl_CustomerMedia', 'COLUMN', N'CustomerMediaDataPart2'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Check type', 'SCHEMA', N'dbo', 'TABLE', N'tbl_CustomerMedia', 'COLUMN', N'CustomerMediaType'
GO
